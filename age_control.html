...
<body>
            ...
            <nav class="navbar navbar-expand-lg d-none d-lg-block">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse ms-5 row text-center" id="navbarNavAltMarkup">
                        ...
                        <div class="col-lg-2">
                           <img src="assets/images/appointimg.png" class="img-fluid"  data-bs-toggle="modal" data-bs-target="#myModalAge"/>
                        </div>
                        <div class="col-lg-3">
   ...
   <!-- Model  -->
   <section>
    <div class="modal fade" id="myModalAge" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
