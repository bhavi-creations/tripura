   ...
   <section>
            ...
            <nav class="navbar navbar-expand-lg d-none d-lg-block">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse ms-5 row text-center" id="navbarNavAltMarkup">
                        ...
                        <div class="col-lg-2">
                           <img src="assets/images/appointimg.png" class="img-fluid" data-bs-toggle="modal" data-bs-target="#myModalothers"/>
                        </div>
                        <div class="col-lg-3">
    ...
    <div class="section1 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="blogs-head" style="font-size: 42px;">Others</h1>
        ...
        <div class="container mt-5  div_first_con">
            <div class="row">
                <div class="col-md-6  d-flex flex-column justify-content-center order-1 order-md-1 mt-2">
                    <img src="assets/images/tattoo2.png" class=" doc_img_one img-fluid" alt="...">
    ...
    <section id="Stretch_Marks_Removal">
        <div class="container mt-5  div_first_con">
            <div class="row">
                ...
                <div class="col-md-6  d-flex flex-column justify-content-center order-1 order-md-2">
                    <img src="assets/images/stretch mark 2large.png" class=" doc_img_one img-fluid" alt="...">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="Keloids">
        <div class="container mt-5  div_first_con">
            <div class="row">
                <div class="col-md-6  d-flex flex-column justify-content-center order-1 order-md-1 mt-2">
                    <img src="assets/images/Keloidslar.png" class=" doc_img_one img-fluid" alt="...">
    ...
    <!-- Ear Piercing -->
    <section id="Ear_Piercing">
        <div class="container mt-5  div_first_con">
            <div class="row">
                <div class="col-md-6  d-flex flex-column justify-content-center order-1 order-md-1 mt-2">
                    <img src="assets/images/ear peircing alrge.png" class=" doc_img_one img-fluid" alt="...">
                </div>
                <div class="col-md-6  order-2 order-md-2 mt-2">
                    <h6 class="shedual_heading">Make a Schedule</h6>
        ...
        <div class="container mt-5  div_first_con">
            <div class="row">
                ...
                <div class="col-md-6  d-flex flex-column justify-content-center order-1 order-md-1">
                    <img src="assets/images/skintaglarge.png" class=" doc_img_one img-fluid" alt="...">
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- HIV Treatment -->
    <section id="HIV_Treatment">
        <div class="container mt-5  div_first_con">
            <div class="row">
                <div class="col-md-6  d-flex flex-column justify-content-center order-1 order-md-1 mt-2">
                    <img src="assets/images/hiv.png" class=" doc_img_one img-fluid" alt="...">
                </div>
                <div class="col-md-6  order-2 order-md-2 mt-2">
                    <h6 class="shedual_heading">Make a Schedule</h6>
                    <h2 class="shedual_para">HIV Treatment</h2>
                    <p class="sahde_color">
    ...
    <!-- Sexual Problems -->
    <section id="Sexual_Problems">
    <div class="container mt-5  div_first_con">
        <div class="row">
            
            <div class="col-md-6 order-2 order-md-1 ">
                <h6 class="shedual_heading">Make a Schedule</h6>
                <h2 class="shedual_para">Sexual Problems</h2>
            ...
            <div class="col-md-6  d-flex flex-column justify-content-center order-1 order-md-2">
                <img src="assets/images/sexual problems (1).png" class=" doc_img_one img-fluid" alt="...">
            </div>
        </div>
    </div>
    </section>
    ...
    <!-- Model  -->
    <section>
        <div class="modal fade" id="myModalothers" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
